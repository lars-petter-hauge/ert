...
class Response(Base):
    ...
    __table_args__ = (
        UniqueConstraint("realization_id", "response_definition_id", name="_uc_realization_reponse_"),
    )
...
class ParameterDefinition(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "name", "group", "ensemble_id", name="_name_ensemble_id_"
        ),
    )
...
class Parameter(Base):
    ...
    parameter_definition = relationship("ParameterDefinition", back_populates="parameters")

    __table_args__ = (
        UniqueConstraint("realization_id", "parameter_definition_id", name="_uc_realization_parameter_"),
    )
    def __repr__(self):
